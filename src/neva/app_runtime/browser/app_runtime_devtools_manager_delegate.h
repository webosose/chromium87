...
class AppRuntimeDevToolsManagerDelegate : public DevToolsManagerDelegate {
 public:
  ...
  AppRuntimeDevToolsManagerDelegate(const AppRuntimeDevToolsManagerDelegate&) =
      delete;
  AppRuntimeDevToolsManagerDelegate& operator=(
      const AppRuntimeDevToolsManagerDelegate&) = delete;
