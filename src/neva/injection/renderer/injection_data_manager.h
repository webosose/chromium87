...
#ifndef NEVA_INJECTION_RENDERER_INJECTION_DATA_MANAGER_H_
#define NEVA_INJECTION_RENDERER_INJECTION_DATA_MANAGER_H_
...
#endif  // NEVA_INJECTION_RENDERER_INJECTION_DATA_MANAGER_H_
