...
// Although the below factory method:
// - makes no sense to the "wayland_external" platform (legacy Wayland backend)
// - will never be called for the "wayland_external" platform
// it still shall persist to avoid the out-of-bounds issue while fetching a
// corresponding constructor hook from the "desktop_factory_ozone_list.cc"
// generated file.
DesktopFactoryOzone* CreateDesktopFactoryOzoneWayland();

DesktopFactoryOzone* CreateDesktopFactoryOzoneWayland_external();
