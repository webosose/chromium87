...
void WaylandTouchscreen::OnTouchDown(void *data,
  ...
  WaylandDisplay::GetInstance()->TouchNotify(
      device_id, seat->GetEnteredWindowHandle(device_id), ui::ET_TOUCH_PRESSED,
      event_info);
}
...
void WaylandTouchscreen::OnTouchMotion(void *data,
  ...
  WaylandDisplay::GetInstance()->TouchNotify(
      device_id, seat->GetEnteredWindowHandle(device_id), ui::ET_TOUCH_MOVED,
      event_info);
}
...
void WaylandTouchscreen::OnTouchCancel(void *data,
  ...
  WaylandDisplay::GetInstance()->TouchNotify(
      device_id, seat->GetEnteredWindowHandle(device_id),
