...
void wl_webos_surface_group_compositor::init(struct ::wl_registry* registry,
                                             int id) {
...
struct ::wl_webos_surface_group*
wl_webos_surface_group_compositor::get_surface_group(const std::string& name) {
  return wl_webos_surface_group_compositor_get_surface_group(
      wl_webos_surface_group_compositor_, name.c_str());
}

wl_webos_surface_group::wl_webos_surface_group(struct ::wl_registry* registry,
                                               int id) {
  init(registry, id);
}
...
wl_webos_surface_group::wl_webos_surface_group() : wl_webos_surface_group_(0) {}

wl_webos_surface_group::~wl_webos_surface_group() {}

void wl_webos_surface_group::init(struct ::wl_registry* registry, int id) {
  wl_webos_surface_group_ = static_cast<struct ::wl_webos_surface_group*>(
      wl_registry_bind(registry, id, &wl_webos_surface_group_interface, 1));
...
struct ::wl_webos_surface_group_layer* wl_webos_surface_group::create_layer(
    const std::string& name,
    int32_t z_index) {
  return wl_webos_surface_group_create_layer(wl_webos_surface_group_,
                                             name.c_str(), z_index);
}
...
void wl_webos_surface_group::attach_anonymous(struct ::wl_surface* surface,
                                              uint32_t z_hint) {
  wl_webos_surface_group_attach_anonymous(wl_webos_surface_group_, surface,
                                          z_hint);
}

void wl_webos_surface_group::allow_anonymous_layers(uint32_t allow) {
  wl_webos_surface_group_allow_anonymous_layers(wl_webos_surface_group_, allow);
}
...
void wl_webos_surface_group::handle_owner_destroyed(
  ...
  static_cast<wl_webos_surface_group*>(data)
      ->webos_surface_group_owner_destroyed();
}
...
void wl_webos_surface_group::init_listener() {
  wl_webos_surface_group_add_listener(wl_webos_surface_group_,
                                      &wl_webos_surface_group_listener_, this);
}
...
void wl_webos_surface_group_layer::init(struct ::wl_registry* registry,
                                        int id) {
...
void wl_webos_surface_group_layer::set_z_index(int32_t z_index) {
  wl_webos_surface_group_layer_set_z_index(wl_webos_surface_group_layer_,
                                           z_index);
}
...
void wl_webos_surface_group_layer::
    webos_surface_group_layer_surface_attached() {}

void wl_webos_surface_group_layer::handle_surface_attached(
    void* data,
    struct ::wl_webos_surface_group_layer* object) {
  static_cast<wl_webos_surface_group_layer*>(data)
      ->webos_surface_group_layer_surface_attached();
}

void wl_webos_surface_group_layer::
    webos_surface_group_layer_surface_detached() {}
