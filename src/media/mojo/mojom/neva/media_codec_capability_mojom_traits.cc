...
#include "media/mojo/mojom/neva/media_codec_capability_mojom_traits.h"

namespace mojo {

// static
bool StructTraits<media::mojom::MediaCodecCapabilityDataView,
                  media::MediaCodecCapability>::
    Read(media::mojom::MediaCodecCapabilityDataView input,
