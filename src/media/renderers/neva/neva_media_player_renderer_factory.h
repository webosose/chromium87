...
#ifndef MEDIA_RENDERERS_NEVA_NEVA_MEDIA_PLAYER_RENDERER_FACTORY_H_
#define MEDIA_RENDERERS_NEVA_NEVA_MEDIA_PLAYER_RENDERER_FACTORY_H_
...
#endif  // MEDIA_RENDERERS_NEVA_NEVA_MEDIA_PLAYER_RENDERER_FACTORY_H_
