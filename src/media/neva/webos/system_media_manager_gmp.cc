...
#include "media/neva/webos/system_media_manager_gmp.h"
...
SystemMediaManagerGmp::SystemMediaManagerGmp(
    ...
    : umedia_client_(umedia_client),
      ...
      weak_factory_(this) {
  VLOG(1) << " umedia_client_=" << umedia_client_.get();
}
