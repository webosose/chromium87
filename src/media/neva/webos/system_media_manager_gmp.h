...
#ifndef MEDIA_NEVA_WEBOS_SYSTEM_MEDIA_MANAGER_GMP_H_
#define MEDIA_NEVA_WEBOS_SYSTEM_MEDIA_MANAGER_GMP_H_
...
class SystemMediaManagerGmp : public SystemMediaManager {
 public:
  ...
  void AudioInfoUpdated(const AudioInfoType& audio_info) override {}
  void VideoInfoUpdated(const VideoInfoType& videoInfo) override {}
...
#endif  // MEDIA_NEVA_WEBOS_SYSTEM_MEDIA_MANAGER_GMP_H_
