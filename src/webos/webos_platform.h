...
#ifndef WEBOS_WEBOS_PLATFORM_H_
#define WEBOS_WEBOS_PLATFORM_H_
...
class WEBOS_EXPORT WebOSPlatform : public PlatformDelegate {
 ...
 private:
  WebOSPlatform();
  WebOSPlatform(const WebOSPlatform&) = delete;
  WebOSPlatform& operator=(const WebOSPlatform&) = delete;
