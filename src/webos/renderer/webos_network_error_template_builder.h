...
#ifndef WEBOS_RENDERER_WEBOS_NETWORK_ERROR_TEMPLATE_BUILDER_H_
#define WEBOS_RENDERER_WEBOS_NETWORK_ERROR_TEMPLATE_BUILDER_H_
...
#endif  // WEBOS_RENDERER_WEBOS_NETWORK_ERROR_TEMPLATE_BUILDER_H_
