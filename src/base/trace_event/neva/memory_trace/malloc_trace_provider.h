...
#ifndef BASE_TRACE_EVENT_NEVA_MEMORY_TRACE_MALLOC_TRACE_PROVIDER_H_
#define BASE_TRACE_EVENT_NEVA_MEMORY_TRACE_MALLOC_TRACE_PROVIDER_H_
...
#endif  // BASE_TRACE_EVENT_NEVA_MEMORY_TRACE_MALLOC_TRACE_PROVIDER_H_
